...
public class MNCalendarVerticalAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ...
            myViewHolder.tv_item_title.setBackgroundColor(mnCalendarVerticalConfig.getMnCalendar_colorTitleBg());
            ...
            myViewHolder.recyclerViewItem.setBackgroundColor(mnCalendarVerticalConfig.getMnCalendar_colorBg());
